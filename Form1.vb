Public Class Form1
    ...
    Private Sub BlueToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles BlueToolStripMenuItem.Click
        ...
        'to change the colours to blue

    End Sub

    Private Sub GreyWhiteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GreyWhiteToolStripMenuItem.Click

        Me.BackColor = Color.Gainsboro
        'to change the colours to grey-white/default
    ...
    Private Sub GreenToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GreenToolStripMenuItem.Click
        ...
        'to change the colours to green
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.MaximizeBox = False
        'prevents the windows from being resized
